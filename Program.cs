                                ...
                                while (routeFlag)
                                {
                                    switch (routeOption)
                                    {
                                        ...
                                        case 4: // Get Routes
                                            ...
                                            routesList.ForEach(x => Console.WriteLine($"{x.Id} | {x.From} | {x.To} | {x.Distance} | {x.PricePerKm}"));
                                            break;
                                        case 5: // Back
                                            routeFlag = false;
                                            break;
                                ...
                                while (vehicleFlag)
                                {
                                    switch (vehicleOption)
                                    {
                                        ...
                                        case 4: // Get Vehicles
                                            ...
                                            vehiclesList.ForEach(x => Console.WriteLine($"{x.Id} | {x.Mark} "));
                                            break;
                                        case 5: // Back
                                            vehicleFlag = false;
                                            break;
                                ...
                                while (modelFlag)
                                {
                                    switch (modelOption)
                                    {
                                        ...
                                        case 4: // Get Models
                                            ...
                                            modelList.ForEach(x => Console.WriteLine($"{x.Id} | {x.Model} | {x.Year} | {x.Price} | {x.Type}"));
                                            break;
                                        case 5: // Back
                                            modelFlag = false;
                                            break;
                                ...
                                while (containerFlag)
                                {
                                    switch (containerOption)
                                    {
                                        ...
                                        case 4: // Get Models
                                            ...
                                            containersList.ForEach(x => Console.WriteLine($"{x.Id} | {x.Coefficient} | {x.IsOpen}"));
                                            break;
                                        case 5: // Back
                                            containerFlag = false;
                                            break;
                                ...
                                while (operableFlag)
                                {
                                    switch (operableOption) 
                                    {
                                        ...
                                        case 4: // Get Operables
                                            ...
                                            operablesList.ForEach(x => Console.WriteLine($"{x.Id} | {x.Coefficient} | {x.IsOperable}"));
                                            break;
                                        case 5: // Back
                                            containerFlag = false;
                                            break;
